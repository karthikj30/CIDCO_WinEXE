...
| [`CIDCO_WEB/`](./CIDCO_WEB) | CIDCO web portal + SFTP intake + database — **poll1** files under `company/month/date/timestamp/`, **poll2** runs the 10-step AQI ingestion and archives |
...
────────────                         ────────────
readings.csv
   │  rename → ABCD123_2026-09-19_16-02-00_AQI.csv
...
SFTP / portal upload ─────────────►  storage/inbox/
                                     ...
                                     poll1 (npm run poll)
                                          ▼
                               company/month/date/timestamp/*.csv
                                          │
                                     poll2
                                          ▼
